...
- **New in v5.2.0:** Navbars can be themed with CSS variables that are scoped to `.navbar`. `.navbar-light` has been deprecated and `.navbar-dark` has been rewritten to override CSS variables instead of adding additional rulesets.
